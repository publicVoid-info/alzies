...
class AccountTab extends Component {
  ...
  handleVerifyEmailAddress = () => {
    this.closeVerifyEmailAddressDialog(() => {
      ...
      this.verifyEmailAddress(this.props.user,
        () => {
          this.props.openSnackbar(`Verification e-mail sent to ${this.props.user.email}`);
        });
    });
  };
  ...
  handleChangeDisplayName = () => {
    ...
    if (this.state.displayName === this.props.user.displayName) {
      this.props.openSnackbar(`Display name is already ${this.state.displayName}`);
  ...
  render() {
    ...
    const isUserComplete = (this.props.user.photoURL && this.props.user.displayName && this.props.user.email);
        ...
        <List>
          <ListItem>
            ...
            {(this.props.user.displayName)
              ?
              <ListItemText primary="Display name" secondary={this.props.user.displayName} />
              :
            ...
            <ListItemText
              ...
              secondary={
                <React.Fragment>
                  ...
                  {(!this.props.user.emailVerified && this.props.isVerifyingEmailAddress) && 'Awaiting e-mail address verification'}
                  {(!this.props.user.emailVerified && !this.props.isVerifyingEmailAddress) && 'Not verified'}
                </React.Fragment>
              }
            />
            <ListItemSecondaryAction>
              {this.props.isVerifyingEmailAddress && <CircularProgress />}
              {(!this.props.isVerifyingEmailAddress && !this.props.user.emailVerified) &&
          ...
          <ListItem>
            ...
            <ListItemText primary="Last sign-in" secondary={moment(this.props.user.metadata.lastSignInTime).format('LLLL')} />
          </ListItem>
          ...
          <ListItem>
            ...
            <ListItemText primary="Signed up" secondary={moment(this.props.user.metadata.creationTime).format('LLLL')} />
          </ListItem>
        </List>
