...
function MemoryCard(props) {
  ...
  const handleRestoreTrashClick = () => {
    ...
    getFirestore()
      .collection('archivedMemoryPosition')
      .doc(user.uid)
      .delete()
        ...
        {!props.activeTable.trash ? (
          ...
          <CardActions className={classes.cardActionButton}>
            <Button
              variant="contained"
              color="primary"
              onClick={handleRestoreTrashClick}
            >
              Restore
            </Button>
            <Button
