...
class WelcomeDialog extends Component {
  ...
  handleVerifyClick = () => {
    ...
    this.props.closeWelcomeDialog(() => {
      self.verifyEmailAddress(self.props.user, () => {
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            will be sent to your e-mail address containing instructions on how
            to verify your e-mail address.
          </DialogContentText>
        </DialogContent>

        <DialogActions>
          <Button color="primary" onClick={this.props.closeWelcomeDialog}>
            Cancel
          </Button>
          <Button
            color="primary"
